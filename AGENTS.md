...
## Estado actual
- **Versión**: v4 — Web con carta real + identidad de marca correcta
- **Fecha**: 2026-05-01
...
## Nuevos assets generados (v4)
17 imágenes únicas en assets/: cachapa_queso, cachapa_pabellon_new, cachapa_mechada, cachapa_reina, quesadilla_queso, quesadilla_carne, quesadilla_pollo, tequenos, patacon_bocados, tapas_variadas, crepe_oreo, crepe_pistacho, waffle_dulcedeleche, waffle_platano, cafe_con_leche, cafe_asiatico, capuchino.
...
└── AGENTS.md         ← Este archivo de memoria del proyecto
```
...
| v3 | 2026-05-01 | Identidad de marca real (colores del logo), carta completa de imágenes del cliente |
| v4 | 2026-05-01 | **Actual** — 17 imágenes únicas por producto, cards mejoradas (hover, border-left, shadow), FAQ acordeón, emoji category badges, scroll-to-top, punto verde en horario |
